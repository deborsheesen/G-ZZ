...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/home/postdoc/dsen/Desktop/G-ZZ/tmp/bernoulli.stan");
    reader.add_event(15, 13, "end", "/home/postdoc/dsen/Desktop/G-ZZ/tmp/bernoulli.stan");
    return reader;
}
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.scalar_lub_unconstrain(0,1,theta1);
        } catch (const std::exception& e) { 
        ...
        try {
            writer__.scalar_lub_unconstrain(0,1,theta2);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                theta1 = in__.scalar_lub_constrain(0,1,lp__);
            else
                theta1 = in__.scalar_lub_constrain(0,1);

            local_scalar_t__ theta2;
            (void) theta2;  // dummy to suppress unused var warning
            if (jacobian__)
                theta2 = in__.scalar_lub_constrain(0,1,lp__);
            else
                theta2 = in__.scalar_lub_constrain(0,1);
            ...
            lp_accum__.add(beta_log<propto__>(theta1, 1, 1));
            current_statement_begin__ = 11;
            lp_accum__.add(beta_log<propto__>(theta2, 1, 1));
            current_statement_begin__ = 12;
            lp_accum__.add(bernoulli_log<propto__>(y, (pow(theta1,2) + theta2)));
    ...
    void write_array(RNG& base_rng__,
        ...
        double theta1 = in__.scalar_lub_constrain(0,1);
        double theta2 = in__.scalar_lub_constrain(0,1);
